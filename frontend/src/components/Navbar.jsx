      ...
      <nav className="glass-header dark:bg-gray-900 dark:border-gray-700 border-b border-gray-100 py-3 px-6 fixed top-0 w-full z-40 transition-colors duration-300">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link to="/" className="text-3xl font-black text-red-600 dark:text-red-500 tracking-tighter flex items-center gap-2 hover:opacity-80 transition-opacity">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative hidden md:block">
              <input 
                ...
                className="pl-10 pr-4 py-2 rounded-full bg-gray-100 dark:bg-gray-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-red-600 focus:bg-white dark:focus:bg-gray-700 transition-all text-sm w-64"
              />
